...
namespace test
{
    class ExcelExportUnitTest : UnitTest
    {
      public override bool test()
      {
        ...
        // Test 1
        RepeatingAccuracyMeasurementSeries series1 = new RepeatingAccuracyMeasurementSeries();
        ...
        // Test 2
        RepeatingAccuracyMeasurementSeries series2 = new RepeatingAccuracyMeasurementSeries();

        seriesCollection.addMeasurementSeries(series2);

        // Test 3
        WayTimeMeasurementSeries series3 = new WayTimeMeasurementSeries();
