...
namespace usb
{
    public class USBAdaption
    {
        ...
        public static void init(MainWindowViewModel viewModel)
        {
            ...
            USBAdaption.serialPort1.PortName = "COM5";
            USBAdaption.serialPort1.BaudRate = 9600;

            USBAdaption.serialPort2.PortName = "COM6";
            ...
            USBAdaption.commandExecuter = new CommandExecuter(viewModel, USBAdaption.serialPort1, USBAdaption.serialPort2);
        }
